package com.kushui.springbootinit.utils;
...
public class ChartUtils {
    private static final Pattern VALID_GEN_CHART_PATTERN =
            Pattern.compile(ChartConstant.GEN_CHART_REGEX, Pattern.COMMENTS);
    /**
    ...
    public static String getValidGenChart(String preGenChart) {
        ...
        ThrowUtils.throwIf(!matcher.find(), ErrorCode.SYSTEM_ERROR, "AI生 成图表错误");
...
public static String genDefaultChartName() {
    return ChartConstant.DEFAULT_CHART_NAME_PREFIX +
            RandomStringUtils.randomAlphabetic(ChartConstant.DEFAULT_CHART_NAME_SUFFIX_LEN);
}
}