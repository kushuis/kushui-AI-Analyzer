...
import com.yupi.springbootinit.config.BackPressureExecutor;
...
import com.yupi.springbootinit.listener.MyRetryListener;
...
import com.yupi.springbootinit.model.entity.Chart_UserId;
...
public class ChartController {
    ...
    public BaseResponse<Page<Chart>> listMyChartByPage(@RequestBody ChartQueryRequest chartQueryRequest,
        ...
        ThrowUtils.throwIf(size > 20, ErrorCode.PARAMS_ERROR);
        //从redis中查询数据
        List<Long> idList = chartMapper.getIdWithPageAndUser(current, size,loginUser.getId());
